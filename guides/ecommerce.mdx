...
## Configuring the Images to display in the search UI

Naviagte to https://dashboard.trieve.ai and open the dataset settings page

Set `IMAGE_METADTA_KEY` to `image_url`
![](https://trieve.b-cdn.net/docs/image_metadta_key.png)
