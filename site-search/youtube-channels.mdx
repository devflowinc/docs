---
title: SiteSearch Youtube Channels Guide
description: "Step by step guide on setting up a scrape of any Youtube channel, configuring the web component, and adding the script tag to your site."
---
...
```javascript tampermonkey script {16}
(function() {
    'use strict';
...
```javascript final tampermonkey script {26-39}
// ==UserScript==
